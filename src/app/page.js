          ...
          <div className="col-lg-3 col-md-4 col-sm-6" key={item.id}>
            <div className="product__item">
              <div
                ...
                data-setbg={item.images && item.images.length > 0 ? item.images[0] : ''}
                style={{ backgroundImage: `url("${item.images && item.images.length > 0 ? item.images[0] : ''}")`, cursor: "pointer" }}
                onClick={() => router.push(`/spdetails/${item.id}`)}
              >
                <ul className="product__hover">
                  <li>
                    <a href={item.images && item.images.length > 0 ? item.images[0] : '#'} className="image-popup" onClick={(e) => e.stopPropagation()}><span className="arrow_expand" /></a>
                  </li>
                  <li>
                    <a href="#" onClick={(e) => e.stopPropagation()}><span className="icon_heart_alt" /></a>
                  </li>
                  <li>
                    <a href="#" onClick={(e) => {
                      e.preventDefault();
              ...
              <div className="product__item__text">
                <h6><Link href={`/spdetails/${item.id}`}>{item.title}</Link></h6>
